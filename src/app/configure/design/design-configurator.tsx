...
import { SafeConfigArgsType, saveConfig } from "./actions";
...
export const DesignConfigurator = ({
  ...
  const { mutate: saveCustomaization, isPending } = useMutation({
    mutationKey: ["save-config"],
    mutationFn: async (args: SafeConfigArgsType) => {
  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        title: "Something went wrong.",
        description:
          "There was a problem saving your customaization, please try again.",
        variant: "destructive",
      });
    }
  }
